document.addEventListener('DOMContentLoaded', function() {
    ...
    function sortLocationSelect() {
        ...
        const specialOptions = ["Kyiv", "Kyiv region"];
        ...
        locationSelect.innerHTML = '<option value="">Region</option>';
    ...
    function updateSelects() {
        ...
        stateSelect.addEventListener('change', () => {
                regionSelect.innerHTML = '<option value="">District</option>';
                ...
                regionSelect.addEventListener('change', () => {
                    settlementSelect.innerHTML = '<option value="">City/town</option>';
                    settlementSelect.disabled = true;
                    streetSelect.disabled = true;
        ...
        stateSelect.addEventListener('change', () => {
                ...
                regionSelect.addEventListener('change', () => {
                    ...
                    settlementSelect.addEventListener('change', () => {
                    jkSelect.innerHTML = '<option value="">RC</option>';
                    jkSelect.disabled = true;
